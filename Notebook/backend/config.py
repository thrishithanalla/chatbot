...
# The model used for OpenAI Whisper API is typically 'whisper-1'.
# The WHISPER_MODEL_SIZE in .env (and loaded as WHISPER_MODEL below) is more for local Whisper installations.
# The application will use 'whisper-1' directly in app.py for API calls.
WHISPER_MODEL_SIZE_FROM_ENV = os.getenv('WHISPER_MODEL_SIZE', 'base') # This is for local Whisper if used.
...
def setup_logging():
    ...
    logger.debug(f"OPENAI_API_KEY={'Present' if OPENAI_API_KEY and OPENAI_API_KEY != 'sk-proj-92rCTIj8mbDyyDQMZzX9T3BlbkFJZ2tivLI9IcTVt9ehIG0J' else 'Not Set or Placeholder'}")